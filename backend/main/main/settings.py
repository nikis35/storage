...
SECRET_KEY = 'django-insecure-4kh_mk-8)_yfe_27@8psn+!33$rgel@^4mw^3aipks!$gc0r7#'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'storage', # Имя базы данных
        'USER': 'niki', # Имя пользователя
        'PASSWORD': 'niki', # Пароль пользователя
